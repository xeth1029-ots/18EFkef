...
'use strict'; (function (a) { "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/exporting", ["highcharts"], function (g) { a(g); a.Highcharts = g; return a }) : a("undefined" !== typeof Highcharts ? Highcharts : void 0) })(function (a) {
    ...
    function (a, b, r, h) {
        ...
        return {
            ...
            lang: { viewFullscreen: "全螢幕模式觀看", exitFullscreen: "關閉全螢幕模式", printChart: "列印", downloadPNG: "下載 PNG圖檔", downloadJPEG: "下載 JPEG圖檔", downloadPDF: "下載 PDF檔", downloadSVG: "下載 SVG向量圖檔", contextButtonTitle: "功能選單" }, navigation: {
                buttonOptions: {
        ...
        F = b.merge, c = b.objectEach, G = {
            ajax: function (a) {
                ...
                var e = h("form", F({ action: a, enctype: "multipart/form-data" }, r), { display: "none" }, m.body); c(b, function (a, b) {
                    h("input", {
                        type: "hidden",
                        name: b, value: a
                    }, null, e)
