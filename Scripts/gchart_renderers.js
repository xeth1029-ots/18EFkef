var _ChartClickHandler = undefined;
    ...
    callWithJQuery(function ($) {
        ...
        makeGoogleChart = function (chartType, extraOptions) {
            return function (pivotData, opts) {
                ...
                /* result.bind("dblclick" ... for ChartEditor ... */
                ...
                google.visualization.events.addListener(wrapper, 'select', function () {
                    ...
                    if (!selection || !selection.row || !selection.column) {
                        console.error("chart.getSelection() 回傳值不符預期!");
                        console.error(chart);
                        return;
                    }

                    var xValue = dataTable.Nf[selection.row].c[0].v;
                    var yLabel = dataTable.Mf[selection.column].label;
                    var yValue = dataTable.Nf[selection.row].c[selection.column].v;

                    console.debug("select: " + xValue + ", " + yLabel + ":" + yValue);
                    if (_ChartClickHandler && typeof _ChartClickHandler == "function") {
                        _ChartClickHandler(xValue, yLabel, yValue);
                    }
                });
                return result;
            };
        ...
        return $.pivotUtilities.gchart_renderers = {
            ...
            "Pie Chart 3D": makeGoogleChart("PieChart", {
                is3D: true
            }),
