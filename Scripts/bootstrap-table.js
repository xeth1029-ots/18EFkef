(function (global, factory) {
	...
	var id = 0;
	var postfix = (parseFloat('0.'+crypto.getRandomValues(new Uint32Array(1))[0]);//owasp (parseFloat('0.'+crypto.getRandomValues(new Uint32Array(1))[0]);
	...
	*/
	...
	var Utils = {
	  ...
	  getEventName: function getEventName(eventPrefix) {
	    ...
	    id = id || "".concat(+new Date()).concat(~~((parseFloat('0.'+crypto.getRandomValues(new Uint32Array(1))[0]) * 1000000));
