    ...
    this.options = {
        ...
        usePolyfillIf: function() {
            if (navigator.appName == "Microsoft Internet Explorer")
            {
                ...
                //20180830 加入對 Netscape 與 Trident 判斷，修正在 Windows 7 內的 IE 11 瀏覽器 pointer-events:none 沒有效果問題
                if (navigator.appName == "Netscape" && navigator.appVersion.indexOf("Trident") >= 0) {
                    return true;
                }
            }
            return false;
