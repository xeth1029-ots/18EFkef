 ...
 (function($) {
   ...
   $.TuCore.charts.JsBarChart = {
      ...
      *
      * @return  pageCollection - collection of initialized items.
      */
     ...
     initCharts: function() {
       ...
       this.collection.each(function(i, el) {
         ...
         var barChartStyles = '',
           ...
           optGridLineWidth = $(el).data('grid-line-width'),
           // Bar Labels
           ...
           if (isOnceCreatedTrue == 1) {
             $(el).find('.ct-series').each(function() {
               ...
               if (optIsGridSolidLine) {
                 barChartStyles += '#barCharts' + i + ' .ct-grid {stroke-dasharray: ' + optGridLineWidth + ';}';
               }
