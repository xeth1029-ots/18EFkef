...
namespace WKEFSERVICE.Commons
{
    ...
    /// </summary>
    public class MDBUtil : WKEFSERVICE.DataLayers.BaseDAO
    {
        ...
        public static void Export(MDBModel model, string fileName, string pwdString = "")
        {
            ...
            {
                dbConn = new System.Data.Odbc.OdbcConnection(@"Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=" + fileName + ";Uid=;Pwd="+ pwdString + ";");
            }
            ...
            try
            {
                dbConn.Open();
                // Drop Table
                //nonqueryCommand.CommandText = string.Format("DROP TABLE {0}", model.TableName);
