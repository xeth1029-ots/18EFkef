...
{
    public class C204MViewModel
    {
        public C204MViewModel() { this.Form = new C204MFormModel(); }

        public C204MFormModel Form { get; set; }

        public C204MDetailModel Detail { get; set; }
    }

    public class C204MFormModel : PagingResultsViewModel
    {
        ...
        public IList<C204MGridModel> Grid { get; set; }
    }

    public class C204MGridModel : SelfReport
    {
        [NotDBField]
    ...
    public class C204MDetailModel : SelfReport
    {
        [NotDBField]
        [Display(Name = "年度")]
