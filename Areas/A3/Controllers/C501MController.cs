...
namespace WKEFSERVICE.Areas.A3.Controllers
{
    public class C501MController : WKEFSERVICE.Controllers.BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            model.Form.Unit = sm.UserInfo.User.UNITID;
        ...
        public ActionResult Index(C501MFormModel form)
        {
            ...
            A3DAO dao = new A3DAO();
            form.Unit = sm.UserInfo.User.UNITID;
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    FuncLogAdd.Do(ModifyEvent.NONE, ModifyType.PRINT, ModifyState.SUCCESS, "A3/C501M", null, form, s_FileName1 + (form.ExportFormat == "0" ? ".xlsx" : ".ods"));
