...
{
    public class C104MController : WKEFSERVICE.Controllers.BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            C104MViewModel model = new C104MViewModel();
        ...
        public ActionResult New()
        {
            ...
            SessionModel sm = SessionModel.Get();
            C104MViewModel model = new C104MViewModel();
            model.Detail = new C104MDetailModel();
        ...
        public ActionResult Detail(string Seq)
        {
            ...
            C104MViewModel model = new C104MViewModel();
            model.Detail = new C104MDetailModel();
            model.Detail = dao.DetailC104M(Seq.TONotNullString());
            model.Detail.Attacheds = dao.DetailAttachedsC104M(Seq.TONotNullString());
            model.Detail.IsNew = false;
            return View("Detail", model);
        }

        [HttpPost]
        public ActionResult DetailAttachedsUpload(C104MViewModel model)
        {
            SessionModel sm = SessionModel.Get();
            AMDAO dao = new AMDAO();
            ...
            {
                // 上傳檔案
                string tmpPath = Server.MapPath(dao.UploadPathC104M);  // 資料夾路徑名
                ...
                FileLogAdd.Do(ModifyType.UPLOAD, ModifyState.SUCCESS, "AM/C104M", file.FileName, tmpFileName);
                // 資料庫新增
                ...
                try
                {
                    ...
                    FuncLogAdd.Do(ModifyEvent.AFTER, ModifyType.CREATE, (keyid >= 1) ? ModifyState.SUCCESS : ModifyState.FAIL, "AM/C104M", Ins, null, "[MsgPostAttached]");
                    dao.CommitTransaction();
                    #endregion
                    #region Model Insert
                    model.Detail._UPLOAD_FILE = null;
                    if (model.Detail.Attacheds == null) model.Detail.Attacheds = new List<C104MAttachedsModel>();
                    model.Detail.Attacheds.Add(new C104MAttachedsModel()
                    {
                ...
                catch (Exception ex)
                {
                    ...
                    if (System.IO.File.Exists(tmpPath + "/" + tmpFileName))
                    {
                        ...
                        FileLogAdd.Do(ModifyType.DELETE, ModifyState.SUCCESS, "AM/C104M", file.FileName, tmpFileName);
                    }
        ...
        public ActionResult Save(C104MDetailModel detail)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                dao.InsertOrUpdateC104M(detail);
            ...
            return (detail.IsNew) ? Index(new C104MFormModel()) : Detail(detail.Seq.TONotNullString());
        }

        [HttpPost]
        public ActionResult Delete(C104MFormModel form)
        {
            SessionModel sm = SessionModel.Get();
            AMDAO dao = new AMDAO();
            ...
            dao.DeleteC104M(form.Seq_forDel.TONotNullString(), sm.UserInfo.UserNo);
