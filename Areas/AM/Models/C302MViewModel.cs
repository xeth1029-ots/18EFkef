...
namespace WKEFSERVICE.Areas.AM.Models
{
    ...
    public class C302MGridModel : Meeting
    {
        [NotDBField]
    ...
    public class C302MDetailModel
    {
        ...
        public IList<C302MDetailRowsModel> DetailRows { get; set; }
    }

    public class C302MDetailRowsModel : MeetingAttend
    {
        [NotDBField]
        public long? ROWID { get; set; }
        ...
        {
            get { return (this.Attend.TONotNullString() == "Y") ? true : false; }
        ...
        {
            get { return (this.TestPassed.TONotNullString() == "Y") ? true : false; }
        ...
        /// </summary>
        [NotDBField]
        public bool MadForced_Bool
        {
            get { return (this.MadForced.TONotNullString() == "Y") ? true : false; }
            set { this.MadForced = (value) ? "Y" : "N"; }
        }
    }
}