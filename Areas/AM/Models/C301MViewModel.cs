...
namespace WKEFSERVICE.Areas.AM.Models
{
    public class C301MViewModel
    {
        ...
        public C301MDetailSignUpModel DetailSignUp { get; set; }
    }
    ...
    public class C301MDetailModel : Meeting
    {
    ...
    {
        public C301MAttachedsModel() { this.isActive = true; }
    ...
    public class C301MDetailSignUpModel : PagingResultsViewModel
    {
        ...
        public IList<C301MDetailSignUpListModel> SignUpList { get; set; }
        ...
        public IList<C301MTeacherPopupListModel> TeacherSearchList { get; set; }
    }

    public class C301MDetailSignUpListModel : MeetingSignUp
    {
        public C301MDetailSignUpListModel() { this.isActive = true; }
    ...
    public class C301MTeacherPopupListModel
    {
        public long? ROWID { get; set; }
